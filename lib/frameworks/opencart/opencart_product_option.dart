...
class _OpencartOptionInputState extends State<OpencartOptionInput> {
  ...
  Widget build(BuildContext context) {
    ...
    String name = HtmlUnescape().convert(widget.option["name"]);
          ...
          if (type == "select")
            InputSelection(
              ...
              onChanged: (item) {
                ...
                double extraPrice = item["price_prefix"] == "+"
          ...
          if (type == "checkbox")
            InputCheckBox(
              ...
              onChanged: (id) {
                ...
                double extraPrice = options.fold(0.0, (sum, option) {
                  if (selectedValue != null &&
                      selectedValue
                          .contains(option["product_option_value_id"])) {
                    double extra = option["price_prefix"] == "+"
