...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m14(date) => " ${date}tarihine kadar geçerlidir";

  static m15(message) => "Hata: ${message}";

  static m16(length) => " \$${length} Ürün Bulundu";
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "removeToWishList" : MessageLookupByLibrary.simpleMessage("İstek Listesine Kaldır"),
